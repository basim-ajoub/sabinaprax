          ...
          <div class="inside-page" id="massagen">
            <div class="inside-page__container">
              ...
              <p class="inside-page__text">
                Ich wende unterschiedliche Massagetechniken wie klassisch
                medizinisch, Bindegewebsmassagen, Fußreflexmassagen an.
              </p>
        ...
        <div class="card service">
          ...
          <div class="inside-page" id="therapie">
            <div class="inside-page__container">
              ...
              <p class="inside-page__text">
                Die manuelle Therapie dient der Behandlung von
        ...
        <div class="card service">
          ...
          <div class="inside-page" id="pmr">
            <div class="inside-page__container">
              ...
              <p class="inside-page__text">
                Körperliche und mentale Spannungen aufspüren und abbauen. Eine
          ...
          <div class="inside-page">
            <div class="inside-page__container">
              ...
              <p class="inside-page__text">
                ...
                Stille und Bewegte Qigong-yangsheng.
              </p>
              <a href="#" class="inside-page__btn inside-page__btn--text"></a>
            </div>
            <!--End flip Card Inside Side-->
